...
export default function(server) {
  ...
  server.create('rental', {city: 'Bratislava', title: 'City without booking', userId: user2.id});

  server.create('booking', {start_at: '2018-04-26', end_at: '2018-04-28', total_price: 123, days: 1, guests: 4, created_at: '2018-04-25', userId: user2.id, rentalId: rental1.id});
